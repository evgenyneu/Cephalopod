...
This is an iOS utility class that allows to fade sounds in and out with `AvAudioPlayer`. It allows to control duration and velocity of the fade. Velocity can vary from linear to logarithmic.

...
This is an iOS utility class that allows to fade in/out sounds with `AvAudioPlayer`. It allows to control duration and velocity of the fade. Velocity can vary from linear to logarithmic.
